...
<div data-type="media" data-alt="This figure shows a line segment from (negative 4, negative 2) up to (negative 2, 1) then up to (2, 2) and then up to (3, 4).">
![This figure shows a line segment from (negative 4, negative 2) up to (negative 2, 1) then up to (2, 2) and then up to (3, 4).](../resources/CNX_IntAlg_Figure_10_05_206_img.jpg)
</div>
</div>
</div>
...
<div data-type="media" data-alt="This figure shows a line segment passing from the point (negative 3, 3) to (negative 1, 2) to (0, negative 2) to (2, negative 4).">
![This figure shows a line segment passing from the point (negative 3, 3) to (negative 1, 2) to (0, negative 2) to (2, negative 4).](../resources/CNX_IntAlg_Figure_10_05_209_img.jpg)
</div>
</div>
</div>
